...
async function test() {
  ...
  // Wait, I don't know if get_triggers exists.
  // I will just use pg through node if I need to, but it's simpler to just modify the React code to handle 409 Conflict.
}
test();
